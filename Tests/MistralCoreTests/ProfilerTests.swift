/**
 * ProfilerTests.swift
 * Unit tests for MistralProfiler (non-MLX dependent tests only)
 *
 ...
 *
 * - MistralProfiler.shared singleton
 * - MistralProfiler.snapshot() memory snapshots
 * - MistralProfiler.profile() step profiling
 * - MistralProfiler.profileAsync() async step profiling
 * - MistralProfiler.getMetrics() generation metrics
 * - MistralProfiler.reset() and timing methods
